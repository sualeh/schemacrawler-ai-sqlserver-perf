...
class TestSQLExecutor:
    ...
    def test_substitute_template_multiple_same_variable(self, executor):
        ...
        template = "SELECT {{field}}, {{field}}_backup FROM table WHERE {{field}} IS NOT NULL"
    ...
    def test_execute_sql_success(self, mock_create_connection, executor):
        ...
        mock_db_connection.get_connection.return_value.__enter__.return_value = mock_connection
        ...
        expected = [
            ...
            },
            {
                "id": 2, 
                "name": "Jane Smith", 
                "created_date": "2023-01-02T13:30:00"
            }
        ]
